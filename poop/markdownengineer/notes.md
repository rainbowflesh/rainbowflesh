...
10. jenkins 如何通过原生方式备份配置 /job 等(通过 jenkins 提供导入导出 /已经拷贝整个目录）
...
想从事的方向: web 开发 (深入到某个语言的实现) -> 开发兼运维 (广泛到应对二线厂商的需求) -> 图形开发 (能够利用到机器学习技术) -> 机器人开发

😵 想学的东西太多了, 这辈子都学不完, 死前搞一搞海马体数据拓扑, 继承给下辈子继续学.
