...
- Cloud-based automated workflow building, monitoring, tracking, and optimization of pipelines and streams.

- Create and implement deep learning support, as well as machine learning infrastructure operation and maintenance-services, and deploy and test deep learning systems on real machine hardware.

- Processing of sensor data, optimization of geometry representation and simulation, and optimization of GPU use.

- Rapid prototyping of web service applications.
...
- Created several additional projects, but not popular.
...
- Master the use of Office and Adobe series.

- Proficiency in using git .

- Master document writing skills.

- Master the English language.

- Can draw (not an artist).

- Good at code specification / language specification.

- Experienced in Powershell & Bash & Zsh.
