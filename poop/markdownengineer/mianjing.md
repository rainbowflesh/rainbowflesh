...
1. [面经](#面经)
   ...
   3. [Hadoop](#hadoop)
      ...
      14. [MapReduce](#mapreduce)
         ...
         9. [Split 机制](#split-机制)
         10. [求 _SQL_ 中每个 id 的最早登录日期和最晚登录日期](#求-sql-中每个-id-的最早登录日期和最晚登录日期)
         11. [_SQL_ 有 1gb 的数据, 按照 login_date 分组](#sql-有-1gb-的数据-按照-login_date-分组)
         12. [YARN 的优势](#yarn-的优势)
         13. [Shuffle 原理与优化](#shuffle-原理与优化)
   4. [Spark](#spark)
      1. [什么是 RDD](#什么是-rdd)
